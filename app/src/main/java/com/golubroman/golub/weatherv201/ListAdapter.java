...
public class ListAdapter extends BaseAdapter{
    ...
    TextView date, status, mintemp, maxtemp;
    ImageView image;
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        date = (TextView)baseView.findViewById(R.id.date_row);
        status = (TextView)baseView.findViewById(R.id.status_row);
        mintemp = (TextView)baseView.findViewById(R.id.mintemp_row);
        maxtemp = (TextView)baseView.findViewById(R.id.maxtemp_row);
